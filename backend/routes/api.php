...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::delete('/me', [AuthController::class, 'destroyAccount'])->middleware('throttle:password-update');
    ...
    Route::middleware('verified')->group(function (): void {
        ...
        Route::middleware('throttle:heavy-api')->group(function (): void {
            ...
            Route::post('/clients/import', [ClientController::class, 'importCsv'])->middleware('throttle:csv-import');
